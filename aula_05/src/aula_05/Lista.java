...
import java.util.Scanner;
           ...
           // (LISTA: o primeiro que entra é o primeiro que sai)
public class Lista {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				//.ADD: método que adiciona um conteúdo a lista
			...
			case 2:
				...
				//EMPTY: para verificar se uma collection está vazia
				if (notas.isEmpty()) {
					System.out.println("Não existem notas cadastradas!");
			  // senão, está cheia
				}else {
					
			       // VAR eNota: identifica o tipo de dado
					for(var eNota : notas)
			...
			case 3:
				...
				//CONTAINS: pra veririfcar se tem a nota na lista
				if(notas.contains(nota))
					                                                         //INDEX OF: posição da nota na lista
			...
			case 6:
				...
				//SORT.NULL: ordena os elementos da lista de forma crescente
				notas.sort(null);
